...
leftFrame=tk.Frame(root,bg=PRIMARY_COLOR, width=440, height=500)
...
convertButton=tk.Button(leftFrame,text="Convert",bg=SECONDARY_COLOR, fg=PRIMARY_COLOR,font=getFont(),relief="flat",activebackground=SCNDY_SHADE1,bd=0)
